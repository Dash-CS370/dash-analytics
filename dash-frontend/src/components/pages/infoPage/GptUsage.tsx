'use client';
import Styles from './GptUsage.module.css';
    ...
    return (
        <div className={Styles.container}>
            <div className={Styles.textContainer}>
                ...
                <hr></hr>
                <p>
                    <span className={Styles.title}>GPT Version: </span>
                ...
                <p>
                    <span className={Styles.title}>Functionality: </span> Use
                ...
                <p>
                    <span className={Styles.title}>Benefits: </span>You agree
                    not to use the website in any way that: Violates any
